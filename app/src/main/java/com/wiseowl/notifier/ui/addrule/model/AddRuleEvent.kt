...
sealed class AddRuleEvent: Event() {
    ...
    data class OnChangeRulePlaceName(val placeName: String): AddRuleEvent()
    ...
    data class OnQueryPlaces(val search: String): AddRuleEvent()
    data class OnSuggestionUpdated(val suggestions: List<Suggestion>?): AddRuleEvent()
